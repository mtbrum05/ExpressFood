...
/**
 * EnderecoEmpresaFixture
 */
class EnderecoEmpresaFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'endereco_empresa_ibfk_1' => ['type' => 'foreign', 'columns' => ['codigo_empresa'], 'references' => ['empresa', 'codigo'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'codigo_empresa' => 1,
                'data_criacao' => 1619032212,
                'data_modificacao' => 1619032212,
                'principal' => 1,
            ],
        ];
        parent::init();
