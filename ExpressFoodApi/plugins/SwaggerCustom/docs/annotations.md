# SwaggerCustom Annotations

SwaggerCustom provides some optional Annotations for enhanced functionality. There are core annotations and extended 
...
- `use SwaggerCustom\Lib\Extension as SwagExt;`
...
best practice. Using them with SwaggerCustom greatly reduces the amount of annotations you need to write. Consider 
...
SwaggerCustom gathers from AuthenticationComponent. See the main documentation for more information.
