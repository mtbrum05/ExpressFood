...
class SwagResponseSchema
{
    ...
    public function __construct(array $values)
    {
        if (isset($values['httpCode'])) {
            ...
            $msg = 'SwaggerCustom: `httpCode` is deprecated, use `statusCode` in SwagResponseSchema';
            Log::warning($msg);
        ...
        if (isset($values['mimeType'])) {
            ...
            $msg = 'SwaggerCustom: `mimeType` is deprecated, use `mimeTypes` in SwagResponseSchema';
            Log::warning($msg);
            deprecationWarning($msg);
        }
