...
use SwaggerCustom\Lib\Annotation\SwagOperation;
...
class OperationFromRouteFactory
{
     ...
     * @param null|\SwaggerCustom\Lib\OpenApi\Schema $schema Schema
     * @return \SwaggerCustom\Lib\OpenApi\Operation|null
     */
    public function create(RouteDecorator $route, string $httpMethod, ?Schema $schema): ?Operation
    {
        ...
        EventManager::instance()->dispatch(
            new Event('SwaggerCustom.Operation.created', $operation, [
                'config' => $config,
                'docBlock' => $docBlock,
