...
use SwaggerCustom\Lib\Annotation\SwagResponseSchema;
use SwaggerCustom\Lib\Configuration;
use SwaggerCustom\Lib\MediaType\Generic;
use SwaggerCustom\Lib\MediaType\HalJson;
use SwaggerCustom\Lib\MediaType\JsonLd;
use SwaggerCustom\Lib\MediaType\Xml as XmlMedia;
use SwaggerCustom\Lib\OpenApi\Content;
use SwaggerCustom\Lib\OpenApi\Operation;
use SwaggerCustom\Lib\OpenApi\Response;
...
class OperationResponse
{
     ...
     *
     * @param \SwaggerCustom\Lib\Annotation\SwagResponseSchema $annotation SwagResponseSchema
