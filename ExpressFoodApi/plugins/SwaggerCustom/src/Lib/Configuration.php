...
class Configuration
{
    ...
    /**
     * @param array $config SwaggerCustom configurations (useful for unit tests mainly). Default: []
    ...
    {
        $deprecationMsg = 'SwaggerCustom: getHotReload() in Configuration will be deprecated, use isHotReload()';
    ...
    public function getLayout(?string $doctype = null): string
    {
        ...
        if ($doctype == 'redoc') {
            return 'SwaggerCustom.redoc';
        }

        return 'SwaggerCustom.default';
    }
    ...
    public function getView(?string $doctype = null): string
    {
        $doctype = empty($doctype) ? $this->getDocType() : $doctype;
        if ($doctype == 'redoc') {
            return 'SwaggerCustom.Swagger/redoc';
        }

        return 'SwaggerCustom.Swagger/index';
    }
