...
use SwaggerCustom\Lib\Annotation\SwagEntityAttribute;
...
/**
 * Creates an instance of SwaggerCustom\Lib\OpenApi\Schema per OpenAPI specifications
 *
 * @internal
 */
class SchemaFactory
{
     ...
     *
     * @param \SwaggerCustom\Lib\Model\ModelDecorator $modelDecorator ModelDecorator
    ...
    public function create(ModelDecorator $modelDecorator, int $propertyType = 6): ?Schema
    {
        ...
        EventManager::instance()->dispatch(
            new Event('SwaggerCustom.Schema.created', $schema, [
     ...
     *
     * @param \Cake\Datasource\EntityInterface $entity EntityInterface
     * @return \SwaggerCustom\Lib\Annotation\SwagEntity
     */
